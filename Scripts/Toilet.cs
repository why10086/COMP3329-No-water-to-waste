...
public class Toilet : MonoBehaviour, InteractableObject
{
    ...
    public string confirmMessage = "Do you want to spend 10L dirty water flushing the toilet? Clean water will be used if you don't have enough dirty water.";
